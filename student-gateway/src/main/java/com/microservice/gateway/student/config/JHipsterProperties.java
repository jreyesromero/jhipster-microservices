...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "microServiceGatewayStudent@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "microServiceGatewayStudent API";

        private String description = "microServiceGatewayStudent API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "microServiceGatewayStudent";
