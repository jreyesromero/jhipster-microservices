...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.setInstanceName("microServiceGatewayStudent");
        ...
        config.getMapConfigs().put("com.microservice.gateway.student.domain.*", initializeDomainMapConfig(jHipsterProperties));
