...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "microServicesStudent@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "microServicesStudent API";

        private String description = "microServicesStudent API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "microServicesStudent";
